	...
	var e =  '<div class="switcher-container">'+
               ...
               '<div class="selector-box">'+
                    ...
                    '<div class="sw-pattern pattern"><h3>Background pattern:</h3>'+
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/1.png"><img th:src="@{/imagess/pattern/1.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/2.png"><img th:src="@{/imagess/pattern/2.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/3.png"><img th:src="@{/imagess/pattern/3.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/4.png"><img th:src="@{/imagess/pattern/4.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/5.png"><img th:src="@{/imagess/pattern/5.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/6.png"><img th:src="@{/imagess/pattern/6.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/7.png"><img th:src="@{/imagess/pattern/7.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/8.png"><img th:src="@{/imagess/pattern/8.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/9.png"><img th:src="@{/imagess/pattern/9.png}" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="imagess/pattern/10.png"><img th:src="@{/imagess/pattern/10.png}" alt="image"></a>' +
                    '</div>'+               
                  '<div class="clearfix"></div>'+
               '</div>'+
            '</div>';
