...
!function (t, e) {
    ...
    var B = {
        head: F, last: P, initial: function (t) {
            return t.slice(0, t.length - 1)
        }, tail: H, prev: function (t, e) {
            if (t && t.length && e) {
                var o = t.indexOf(e);
    ...
    function Ct(t, e) {
        ...
        var r = t.node.childNodes[t.offset], s = ct(t.node.cloneNode(!1), t.node);
    ...
    var $t = {
        ...
        commonAncestor: function (t, e) {
            for (var o = at(t), n = e; n; n = n.parentNode) if (-1 < o.indexOf(n)) return n;
            return null
        },
        wrap: function (t, e) {
            var o = t.parentNode, n = C("<" + e + ">")[0];
        ...
        splitPoint: function (t, e) {
            var o, n, i = e ? K : X, r = at(t.node, i), s = B.last(r) || t.node;
        ...
        posFromPlaceholder: function (t) {
            var e = C(t), o = e.offset(), n = e.outerHeight(!0);
        ...
        return t.prototype.initialize = function () {
            ...
            var e = this, o = C.extend({}, this.options.buttons);
            Object.keys(o).forEach(function (t) {
                e.memo("button." + t, o[t])
            });
            ...
            var t = B.head(arguments), e = B.tail(B.from(arguments)),
            ...
            var t = B.head(arguments), e = B.tail(B.from(arguments)), o = t.split("."), n = 1 < o.length,
                i = n && B.head(o), r = n ? B.last(o) : B.head(o), s = this.modules[i || "editor"];
            return !i && this[r] ? this[r].apply(this, e) : s && s[r] && s.shouldInitialize() ? s[r].apply(s, e) : void 0
        }, t
    }();

    function Et(t, e) {
        var o, n, i = t.parentElement(), r = document.body.createTextRange(), s = B.from(i.childNodes);
        for (o = 0; o < s.length; o++) if (!$t.isText(s[o])) {
    ...
    function Rt(t) {
        var s = function (t, e) {
            var o, n;
            if ($t.isText(t)) {
                var i = $t.listPrev(t, A.not($t.isText)), r = B.last(i).previousSibling;
    ...
    C.fn.extend({
        summernote: function () {
            var t = C.type(B.head(arguments)), e = "string" === t, o = "object" === t,
    ...
    var Lt = function () {
        ...
        return r.prototype.nativeRange = function () {
            ...
            return e.setEndPoint("EndToEnd", Rt({node: this.ec, offset: this.eo})), e
            ...
            var e = $t.ancestor(this.sc, t), o = $t.ancestor(this.ec, t);
            ...
            var e = C("<div></div>").html(t)[0], o = B.from(e.childNodes),
            ...
            return {
                s: {path: B.tail($t.makeOffsetPath(B.head(t), this.sc)), offset: this.so},
                e: {path: B.tail($t.makeOffsetPath(B.last(t), this.ec)), offset: this.eo}
            }
        ...
        create: function (t, e, o, n) {
            ...
            var e = t, o = 0, n = t, i = $t.nodeLength(n);
            ...
            var o = $t.fromOffsetPath(t, e.s.path), n = e.s.offset, i = $t.fromOffsetPath(t, e.e.path), r = e.e.offset;
            return new Lt(o, n, i, r)
        }, createFromParaBookmark: function (t, e) {
            var o = t.s.offset, n = t.e.offset, i = $t.fromOffsetPath(B.head(e), t.s.path),
        ...
        }, nameFromCode: A.invertObject(Ft), code: Ft
    };
    var Ht = function () {
        function t(t) {
        ...
        return t.prototype.jQueryCSS = function (o, t) {
            ...
            var r = $t.makePredByNodeName(o), s = t.nodes($t.isText, {fullyContains: !0}).map(function (t) {
            ...
            if (n) {
                ...
                return s.map(function (t) {
                    var e = $t.withClosestSiblings(t, r), o = B.head(e), n = B.tail(e);
            ...
            var e = C($t.isElement(t.sc) ? t.sc : t.sc.parentNode), o = this.fromNode(e);
            try {
                o = C.extend(o, {
        ...
        return t.prototype.insertOrderedList = function (t) {
            ...
            var i = this, e = At.create(t).wrapBodyInlineWithPara(), o = e.nodes($t.isPara, {includeAncestor: !0}),
            ...
            var n = this, e = At.create(t).wrapBodyInlineWithPara(), o = e.nodes($t.isPara, {includeAncestor: !0}),
            ...
            var n = this, e = At.create(t).wrapBodyInlineWithPara(), i = e.nodes($t.isPara, {includeAncestor: !0}),
                r = e.paraBookmark(i), s = B.clusterBy(i, A.peq2("parentNode"));
            ...
            var o = B.head(t), n = B.last(t), i = $t.isList(o.previousSibling) && o.previousSibling,
                r = $t.isList(n.nextSibling) && n.nextSibling, s = i || $t.insertAfter($t.create(e || "UL"), n);
            ...
            var d = this, u = [];
            return C.each(t, function (t, e) {
                var o = B.head(e), n = B.last(e), i = c ? $t.lastAncestor(o, $t.isList) : o.parentNode,
                    r = i.parentNode;
    ...
    var Ot, Ut = function () {
        ...
        return t.prototype.tab = function (t, e) {
            var o = $t.ancestor(t.commonAncestor(), $t.isCell), n = $t.ancestor(o, $t.isTable),
                i = $t.listDescendant(n, $t.isCell), r = B[e ? "prev" : "next"](i, o);
            ...
            var o = $t.ancestor(t.commonAncestor(), $t.isCell), n = C(o).closest("tr");
            C(n).siblings().push(n);
            ...
            for (var e = $t.ancestor(t.commonAncestor(), $t.isCell), o = C(e).closest("tr"), n = o.children("td, th").index(C(e)), i = o[0].rowIndex, r = new Mt(e, Mt.where.Row, Mt.requestAction.Delete, C(o).closest("table")[0]).getActionList(), s = 0; s < r.length; s++) if (r[s]) {
            ...
            for (var e = $t.ancestor(t.commonAncestor(), $t.isCell), o = C(e).closest("tr"), n = o.children("td, th").index(C(e)), i = new Mt(e, Mt.where.Column, Mt.requestAction.Delete, C(o).closest("table")[0]).getActionList(), r = 0; r < i.length; r++) if (i[r]) switch (i[r].action) {
                case Mt.resultAction.Ignore:
                    continue;
                case Mt.resultAction.SubtractSpanCount:
                    var s = i[r].baseCell;
        ...
        function t(t) {
            ...
            this.insertParagraph = this.wrapCommand(function () {
                ...
                var o = t.url, e = t.text, n = t.isNewWindow, i = t.range || u.getLastRange(),
        ...
        return t.prototype.initialize = function () {
            ...
            var e = this.options.keyMap[R.isMac ? "mac" : "pc"], o = [];
            ...
            var t = this.getLastRange().expand($t.isAnchor), e = C(B.head(t.nodes($t.isAnchor))),
        ...
        return t.prototype.initialize = function () {
            ...
            var i = this, n = C(), r = this.$dropzone.find(".note-dropzone-message");
    ...
    var qt = function () {
        ...
        return t.prototype.initialize = function () {
            ...
            var o = $t.isImg(t), n = this.$handle.find(".note-control-selection");
            if (this.context.invoke("imagePopover.update", t, e), o) {
                var i = C(t), r = i.position(), s = {
        ...
        return t.prototype.initialize = function () {
            ...
            if (this.lastWordRange) {
                ...
                if (e && (e[1] || e[2])) {
                    var o = e[1] ? t : "http://" + t, n = C("<a />").html(t).attr("href", o)[0];
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            if (this.lastWord) {
                var o = this, t = this.lastWord.toString();
        ...
        return t.prototype.representShortcut = function (t) {
            ...
            return this.ui.buttonGroup({
                ...
                children: [this.button({
                    ...
                    click: function (t) {
                        t.stopPropagation();
                        var e = C("." + h), o = C(t.target), n = o.data("event"), i = o.attr("data-value");
                        if ("openPalette" === n) {
                            var r = e.find("#" + i), s = C(e.find("#" + r.data("event")).find(".note-color-row")[0]),
            ...
            var e, o = C(t.target.parentNode), n = o.next(), i = o.find(".note-dimension-picker-mousecatcher"),
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            var r = this.$document.scrollTop(), s = this.$editor.offset().top, a = s - i, l = s + t - i - o - n;
            !this.isFollowing && a < r && r < l - o ? (this.isFollowing = !0, this.$toolbar.css({
                position: "fixed",
                top: i,
                width: e
            }), this.$editable.css({marginTop: this.$toolbar.height() + 5})) : this.isFollowing && (r < a || l < r) && (this.isFollowing = !1, this.$toolbar.css({
                position: "relative",
                top: 0,
                width: "100%"
        ...
        return t.prototype.initialize = function () {
            ...
            return C.Deferred(function (e) {
                var o = a.$dialog.find(".note-link-text"), n = a.$dialog.find(".note-link-url"),
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            if (this.context.invoke("editor.hasFocus")) {
                ...
                if (t.isCollapsed() && t.isOnAnchor()) {
                    var e = $t.ancestor(t.sc, $t.isAnchor), o = C(e).attr("href");
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            if ($t.isImg(t)) {
                var o = $t.posFromPlaceholder(t), n = $t.posFromPlaceholder(this.editable);
                this.$popover.css({
                    display: "block",
        ...
        return t.prototype.initialize = function () {
            ...
            if (o && 11 === o[1].length) {
                ...
                if (void 0 !== o[2]) {
                    ...
                    if (g) for (var v = [3600, 60, 1], b = 0, y = v.length; b < y; b++) m += void 0 !== g[b + 1] ? v[b] * parseInt(g[b + 1], 10) : 0
                }
            ...
            var n = this;
            return C.Deferred(function (e) {
                var o = n.$dialog.find(".note-video-url"), t = n.$dialog.find(".note-video-btn");
        ...
        return t.prototype.initialize = function () {
            ...
            var n = this, i = this.options.keyMap[R.isMac ? "mac" : "pc"];
            return Object.keys(i).map(function (t) {
                var e = i[t], o = C('<div><div class="help-list-item"/></div>');
        ...
        return t.prototype.shouldInitialize = function () {
            ...
            var o = this, n = C('<div class="note-hint-group note-hint-group-' + e + '"/>');
            ...
            if (!B.contains([Pt.code.ENTER, Pt.code.UP, Pt.code.DOWN], t.keyCode)) {
                var e = this.context.invoke("editor.getLastRange").getWordRange(), n = e.toString();
    ...
    C.summernote = C.extend(C.summernote, {
        version: "0.8.12", plugins: {}, dom: $t, range: At, options: {
    ...
    }), C.summernote = C.extend(C.summernote, {ui: b}), C.summernote.options.styleTags = ["p", {
        title: "Blockquote",
        tag: "blockquote",
