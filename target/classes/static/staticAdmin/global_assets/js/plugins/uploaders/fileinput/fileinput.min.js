...
!function (e) {
    ...
    t = {
        ...
        constructor: i, _cleanup: function () {
            ...
            var i, a, r, n, o, l, s, d, c, u, p, f, g, m, v, h, w, b, _, C, y, x, T, I, F, P, E, k, S, A, z, D, M, U, $,
                j, R, O, B, L, Z, N = this;
            i = '{preview}\n<div class="kv-upload-progress kv-hidden"></div><div class="clearfix"></div>\n<div class="input-group {class}">\n  {caption}\n<div class="input-group-btn input-group-append">\n      {remove}\n      {cancel}\n      {pause}\n      {upload}\n      {browse}\n    </div>\n</div>', a = '{preview}\n<div class="kv-upload-progress kv-hidden"></div>\n<div class="clearfix"></div>\n{remove}\n{cancel}\n{upload}\n{browse}\n', r = '<div class="file-preview {class}">\n  {close}  <div class="{dropClass} clearfix">\n    <div class="file-preview-thumbnails clearfix">\n    </div>\n    <div class="file-preview-status text-center text-success"></div>\n    <div class="kv-fileinput-error"></div>\n  </div>\n</div>', o = t.closeButton("fileinput-remove"), n = '<i class="glyphicon glyphicon-file"></i>', l = '<div class="file-caption form-control {class}" tabindex="500">\n  <span class="file-caption-icon"></span>\n  <input class="file-caption-name" onkeydown="return false;" onpaste="return false;">\n</div>', s = '<button type="{type}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</button>', d = '<a href="{href}" tabindex="500" title="{title}" class="{css}" {status}>{icon} {label}</a>', c = '<div tabindex="500" class="{css}" {status}>{icon} {label}</div>', u = '<div id="' + t.MODAL_ID + '" class="file-zoom-dialog modal fade" tabindex="-1" aria-labelledby="' + t.MODAL_ID + 'Label"></div>', p = '<div class="modal-dialog modal-lg{rtl}" role="document">\n  <div class="modal-content">\n    <div class="modal-header">\n      <h5 class="modal-title">{heading}</h5>\n      <span class="kv-zoom-title"></span>\n      <div class="kv-zoom-actions">{toggleheader}{fullscreen}{borderless}{close}</div>\n    </div>\n    <div class="modal-body">\n      <div class="floating-buttons"></div>\n      <div class="kv-zoom-body file-zoom-content {zoomFrameClass}"></div>\n{prev} {next}\n    </div>\n  </div>\n</div>\n', f = '<div class="progress">\n    <div class="{class}" role="progressbar" aria-valuenow="{percent}" aria-valuemin="0" aria-valuemax="100" style="width:{percent}%;">\n        {status}\n     </div>\n</div>{stats}', Z = '<div class="text-info file-upload-stats"><span class="pending-time">{pendingTime}</span> <span class="upload-speed">{uploadSpeed}</span></div>', g = " <samp>({sizeText})</samp>", m = '<div class="file-thumbnail-footer">\n    <div class="file-footer-caption" title="{caption}">\n        <div class="file-caption-info">{caption}</div>\n        <div class="file-size-info">{size}</div>\n    </div>\n    {progress}\n{indicator}\n{actions}\n</div>', v = '<div class="file-actions">\n    <div class="file-footer-buttons">\n        {download} {upload} {delete} {zoom} {other}    </div>\n</div>\n{drag}\n<div class="clearfix"></div>', h = '<button type="button" class="kv-file-remove {removeClass}" title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button>\n', w = '<button type="button" class="kv-file-upload {uploadClass}" title="{uploadTitle}">{uploadIcon}</button>', b = '<a class="kv-file-download {downloadClass}" title="{downloadTitle}" href="{downloadUrl}" download="{caption}" target="_blank">{downloadIcon}</a>', _ = '<button type="button" class="kv-file-zoom {zoomClass}" title="{zoomTitle}">{zoomIcon}</button>', C = '<span class="file-drag-handle {dragClass}" title="{dragTitle}">{dragIcon}</span>', y = '<div class="file-upload-indicator" title="{indicatorTitle}">{indicator}</div>', x = '<div class="file-preview-frame {frameClass}" id="{previewId}" data-fileindex="{fileindex}" data-fileid="{fileid}" data-template="{template}"', T = x + '><div class="kv-file-content">\n', I = x + ' title="{caption}"><div class="kv-file-content">\n', F = "</div>{footer}\n</div>\n", P = "{content}\n", O = " {style}", E = '<div class="kv-preview-data file-preview-html" title="{caption}"' + O + ">{data}</div>\n", k = '<img src="{data}" class="file-preview-image kv-preview-data" title="{title}" alt="{alt}"' + O + ">\n", S = '<textarea class="kv-preview-data file-preview-text" title="{caption}" readonly' + O + ">{data}</textarea>\n", A = '<iframe class="kv-preview-data file-preview-office" src="https://view.officeapps.live.com/op/embed.aspx?src={data}"' + O + "></iframe>", z = '<iframe class="kv-preview-data file-preview-gdocs" src="https://docs.google.com/gview?url={data}&embedded=true"' + O + "></iframe>", D = '<video class="kv-preview-data file-preview-video" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</video>\n", M = '<!--suppress ALL --><audio class="kv-preview-data file-preview-audio" controls' + O + '>\n<source src="{data}" type="{type}">\n' + t.DEFAULT_PREVIEW + "\n</audio>\n", U = '<embed class="kv-preview-data file-preview-flash" src="{data}" type="application/x-shockwave-flash"' + O + ">\n", j = '<embed class="kv-preview-data file-preview-pdf" src="{data}" type="application/pdf"' + O + ">\n", $ = '<object class="kv-preview-data file-preview-object file-object {typeCss}" data="{data}" type="{type}"' + O + '>\n<param name="movie" value="{caption}" />\n' + t.OBJECT_PARAMS + " " + t.DEFAULT_PREVIEW + "\n</object>\n", R = '<div class="kv-preview-data file-preview-other-frame"' + O + ">\n" + t.DEFAULT_PREVIEW + "\n</div>\n", B = '<div class="kv-zoom-cache" style="display:none">{zoomContent}</div>', L = {
                ...
                previewMarkupTags: {tagBefore1: T, tagBefore2: I, tagAfter: F},
            ...
            return i || r.length || a._log(t.logMessages.invalidThumb, {id: e}), r
        }, _getZoom: function (e, i) {
            var a = this, r = t.getZoomElement(a.$preview, e, i);
            return r.length || a._log(t.logMessages.invalidThumb, {id: e}), r
            ...
            var n, o, l, s, d, c, u, p, f, g, m, v, h, w = this, b = w.fileManager, _ = b.count(), C = new FormData,
                ...
                T = w.ajaxOperations.uploadThumb, I = b.getFile(a), F = {id: y, index: i, fileId: a},
                P = w.fileManager.getFileName(a, !0);
            w.enableResumableUpload || (w.showPreview && (o = w.fileManager.getThumb(a), u = o.find(".file-thumb-progress"), s = o.find(".kv-file-upload"), d = o.find(".kv-file-remove"), u.show()), 0 === _ || !x || w.showPreview && s && s.hasClass("disabled") || w._abort(F) || (h = function () {
                ...
                f = w._parseError(T, t, n, w.fileManager.getFileName(a)), c = !0, setTimeout(function () {
                    r && h(), w.fileManager.setProgress(a, 100), w._setPreviewError(o, !0), w.retryErrorUploads || s.hide(), e.extend(!0, F, w._getOutData(C, t)), w._setProgress(101, u, w.msgAjaxProgressError.replace("{operation}", T)), w._setProgress(101, o.find(".file-thumb-progress"), w.msgUploadError), w._showFileError(f, F)
                }, w.processDelay)
            }, C.append(w.uploadFileAttr, I.file, P), w._setUploadData(C, {fileId: a}), w._ajaxSubmit(p, g, m, v, C, a, i)))
            ...
            var v, h, w, b = this, _ = b.slug(r), C = "", y = "",
                ...
                I = _, F = "type-default", P = u || b._renderFileFooter(i, _, d, "auto", s), E = b.preferIconicPreview,
            ...
            var o, l, s, d, c, u, p, f, g, m, v = this, h = e(a.img)[0], w = h.naturalWidth, b = h.naturalHeight, _ = 1,
                ...
                I = v.imageCanvasContext, F = a.typ, P = a.pid, E = a.ind, k = a.thumb, S = a.exifObj;
            if (c = function (e, t, i) {
            ...
            F = F || v.resizeDefaultImageType, l = w > C, s = b > y, _ = "width" === v.resizePreference ? l ? C / w : s ? y / b : 1 : s ? y / b : l ? C / w : 1, v._resetCanvas(), w *= _, b *= _, T.width = w, T.height = b;
            try {
                I.drawImage(h, 0, 0, w, b), d = T.toDataURL(F, v.resizeQuality), S && (p = window.piexif.dump(S), d = window.piexif.insert(p, d)), o = t.dataURI2Blob(d), v.fileManager.setFile(i, o), v._raise("fileimageresized", m), r.val++, r.val === n && v._raise("fileimagesresized", [void 0, void 0]), o instanceof Blob || c(v.msgImageResizeError, g, "fileimageresizeerror")
            } catch (A) {
            ...
            var a, r = this, n = r.$element, o = r.reader, l = r.$previewContainer, s = r.$previewStatus,
                ...
                h = t.isEmpty(v) ? "" : v.join(", "), w = function (t, n, o, l, s, d) {
                    var c = e.extend(!0, {}, r._getOutData(null, {}, {}, i), {id: o, index: l, fileId: s}),
                        u = r._getFrame(o, !0), f = {id: o, index: l, fileId: s, file: n, files: i};
                    d = d || r.removeFromPreviewOnError, d || r._previewDefault(n, !0), r.isAjaxUpload ? setTimeout(function () {
                        a(l + 1)
                    }, r.processDelay) : (r.unlock(), p = 0), d || (r._initFileActions(), u.remove()), r.isError = r.isAjaxUpload ? r._showFileError(t, c) : r._showError(t, f), r._updateFileDetails(p)
                };
            r.fileManager.clearImages(), e.each(i, function (e, t) {
                ...
                r.lock(!0);
                var _, C, y, x, T, I, F, P, E, k, S, A, z, D = i[b], M = u + "-" + r._getFileId(D), U = f.text,
                ...
                if (D) {
                    if (P = r.fileManager.getId(D), m > 0) for (C = 0; m > C; C++) I = g[C], F = r.msgFileTypes[I] || I, N += 0 === C ? F : ", " + F;
                    if (R === !1) return void a(b + 1);
                    if (0 === R.length) return y = r.msgInvalidFileName.replace("{name}", t.htmlEncode(t.getFileName(D), "[unknown]")), void w(y, D, M, b, P);
                    if (t.isEmpty(v) || (B = new RegExp("\\.(" + v.join("|") + ")$", "i")), _ = O.toFixed(2), r.isAjaxUpload && r.fileManager.exists(P) || r._getFrame(M, !0).length) return y = r.msgDuplicateFile.setTokens({
                        name: R,
                        size: _
                    }), w(y, D, M, b, P, !0), void (r.isAjaxUpload || (r._clearFileInput(), r.reset()));
                    if (r.maxFileSize > 0 && O > r.maxFileSize) return y = r.msgSizeTooLarge.setTokens({
                        name: R,
                        size: _,
                        maxSize: r.maxFileSize
                    }), void w(y, D, M, b, P);
                    if (null !== r.minFileSize && O <= t.getNum(r.minFileSize)) return y = r.msgSizeTooSmall.setTokens({
                        name: R,
                        size: _,
                        minSize: r.minFileSize
                    }), void w(y, D, M, b, P);
                    if (!t.isEmpty(g) && t.isArray(g)) {
                        for (C = 0; C < g.length; C += 1) x = g[C], E = f[x], Z += E && "function" == typeof E && E(D.type, t.getFileName(D)) ? 1 : 0;
                        if (0 === Z) return y = r.msgInvalidFileType.setTokens({
                            name: R,
                            types: N
                        }), void w(y, D, M, b, P)
                    }
                    if (0 === Z && !t.isEmpty(v) && t.isArray(v) && !t.isEmpty(B) && (T = t.compare(R, B), Z += t.isEmpty(T) ? 0 : T.length, 0 === Z)) return y = r.msgInvalidFileExtension.setTokens({
                        name: R,
                        extensions: h
                    }), void w(y, D, M, b, P);
                    ...
                    k = U(D.type, R), S = j(D.type, R), A = $(D.type, R), s.html(d.replace("{index}", b + 1).replace("{files}", p)), l.addClass("file-thumb-loading"), o.onerror = function (e) {
                        r._errorHandler(e, R)
                    }, o.onload = function (i) {
                        ...
                        if (n = {name: R, type: D.type}, e.each(f, function (e, t) {
                            ...
                            if (a = u.join("").toLowerCase().substring(0, 8), c = t.getMimeType(a, "", ""), t.isEmpty(c) && (d = t.arrayBuffer2String(o.result), c = t.isSvg(d) ? "image/svg+xml" : t.getMimeType(a, d, D.type)), n = {
                                name: R,
                                type: c
                            }, k = U(c, ""), S = j(c, ""), A = $(c, ""), z = k || S, z || A) return void p(z)
                        }
                        r._previewFile(b, D, i, L, n), r._initFileActions(), W()
                    }, o.onprogress = function (e) {
                        if (e.lengthComputable) {
                            var t = e.loaded / e.total * 100, i = Math.ceil(t);
                            y = c.setTokens({index: b + 1, files: p, percent: i, name: R}), setTimeout(function () {
                                s.html(y)
                            }, r.processDelay)
                        }
                    }, k || S ? o.readAsText(D, r.textEncoding) : A ? o.readAsDataURL(D) : o.readAsArrayBuffer(D), r.fileManager.add(D)
                }
